...
var CategoriesService = /** @class */ (function () {
    function CategoriesService(categoriesRepo) {
    ...
    CategoriesService.prototype.findOne = function (id) {
        return this.categoriesRepo.findOne({ where: { id: id } });
    };
    CategoriesService.prototype.create = function (category) {
        return this.categoriesRepo.save(category);
    };
    CategoriesService.prototype.update = function (id, updateData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoriesRepo.update(id, updateData)];
                    case 1:
                        _a.sent();
    ...
    CategoriesService.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoriesRepo.delete(id)];
                    case 1:
                        _a.sent();
